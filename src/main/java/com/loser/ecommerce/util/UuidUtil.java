package com.loser.ecommerce.util;
...
public class UuidUtil {
     ...
     * @return UUID String.
     */
    public static String getTimeUUIDStr() {
        return UuidUtil.getTimeUUID().toString().replace("-", "");
    }

    /**
     * Create a new random-based UUID.
     *
     * @return UUID String.
     */
    public static String getRandomUUIDStr() {
        return UuidUtil.getRandomUUID().toString().replace("-", "");
    }
}
